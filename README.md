...
> EXPERIMENTAL: Sailor CMS is primarily built for my own needs, and it can be considered early beta. It uses the experimental remote functions. Use at your own risk!
...
- **Revision History** - Opt-in per-collection snapshots with inline diff and one-click restore
...
- **Revision History** - Opt in per template; browse past saves with inline diff and restore in one click
...
- **Locale-Aware Admin** - Per-user date format preference (BCP-47), with central helpers ready for i18n
...
- **[Utilities](https://jonkristian.github.io/sailorcms/reference/utilities)** - Frontend helpers and API reference
